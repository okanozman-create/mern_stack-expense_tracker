  ...
  const handleRegister = async () => {
    try {
      ...
      if (response.status === 201) {
        ...
        setUsername(""); // Clear username input after registration
...
//                 <div className="mt-2">
//                   <input id="username" name="username" type="text" autoComplete="username" required value={username} onChange={(e) => setUsername(e.target.value)} className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
//                 </div>
//               </div>
