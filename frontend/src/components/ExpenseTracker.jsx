...
const ExpenseTracker = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      ...
      try {
        const response = await axios.get("https://expense-tracker-mern-git-master-okans-projects-fdd8025d.vercel.app/expenses", {
          headers: {
            "x-auth-token": token,
          },
        });
  ...
  const addExpense = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://expense-tracker-mern-git-master-okans-projects-fdd8025d.vercel.app/expenses",
        newExpense,
        {
          headers: {
            "x-auth-token": token,
  ...
  const handleDelete = async (index) => {
    ...
    try {
      const token = localStorage.getItem("awsToken");
      await axios.delete(
        `https://expense-tracker-mern-git-master-okans-projects-fdd8025d.vercel.app/expenses/${transactionToDelete._id}`,
        {
          headers: {
            "x-auth-token": token,
          }
